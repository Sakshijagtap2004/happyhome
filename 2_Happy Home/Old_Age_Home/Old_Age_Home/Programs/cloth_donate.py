...
def onClick():
    ...
    sql = "INSERT INTO cloth_donation (name, contact, alt_contact, email, slot_date, time_slot, ngo) VALUES (%s, %s, %s, %s, %s, %s, %s)"
...
heading = Label(frame, text='CLOTH DONATION', fg='#160c17', bg='#78b3d0', font=("Helvetica", 23, 'bold'))
